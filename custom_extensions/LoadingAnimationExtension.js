  ...
  render: ({ trace, element }) => {
    ...
    const messageSequences = {
      analysis: {
        ...
        KB_WS: ['Hledám odpověď v databázi Bělkovic-Lašťan.', 'Zpracovávám informace.', 'Ještě okamžik.']
      },
      rewrite: ['Připravuji výstižnější odpověď.'],
      output: {
        SMT: ['Tvořím odpověď.'],
        KB_WS: [
          'Hledám v databázi Bělkovic-Lašťan.',
      ...
      all: {
        KB: [
          'Procházím databázi Bělkovic-Lašťan.',
    ...
    try {
      ...
      spinnerAnimationContainer.style.setProperty('--spinner-point-colour', '#26770E');
